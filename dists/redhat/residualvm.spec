...
%build
(cd libmad-0.15.1b; ./configure --enable-static --disable-shared --prefix=%{_builddir}/residualvm-%{version}/tmp; make; make install)
(cd libmpeg2-0.5.1; ./configure --enable-static --disable-shared --prefix=%{_builddir}/residualvm-%{version}/tmp; make; make install)
...
%doc AUTHORS README NEWS COPYING COPYING.LGPL COPYING.BSD COPYING.FREEFONT COPYRIGHT
