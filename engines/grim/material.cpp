...
Material::Material(const Common::String &filename, const char *data, int len, void *cmap) :
		Object(), _fname(filename), _cmap((CMap *)cmap) {
	...
	g_driver->createMaterial(this, data, _cmap);
}
