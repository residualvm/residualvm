...
Costume::Costume(const Common::String &fname, Common::SeekableReadStream *data, Costume *prevCost, bool doLoad) :
	...
	// Don't load when we're a superclass in EMI
	if (doLoad) {
...
void Costume::load(TextSplitter &ts, Costume *prevCost) {
